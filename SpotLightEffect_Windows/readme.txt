...
The program implements the Spotlights that can be used to 
illuminate a target model object. The
program uses environmental mapping and spotlights to light 2 objects(
...
Name:  SpotLights.vert
   Contains the definition for the vertex shader.
   Contains the logic for calculating and interpolating position.
   Contains the logic for implementing the spotlight.  

Name: SpotLights.frag
...
Name: CubemapSpotlights.vert
   Contains the definition for the vertex shader.
   Contains the logic for calculating and interpolating position.
   Contains the logic for environmental mapping on the object.

Name: CubemapSpotlights.frag
   Defines a function for computing the total fragment color.
   Defines a function for computing the fragment color for each light.
   Contains the material properties.
   Contains the logic for calculating the diffuse, specular and 
...
1. Uncompress the homework.  The homework file is compressed.  
   ...
   Now you should see a directory named 2807HW2 with the files:
        SGPU_HW2.sln
        SGPU_HW2
        readme.txt
	Screenshot 1
...
2. Build and run the program.
    ...
    Open the SGPUHW2.sln file in the Visual Studio.
