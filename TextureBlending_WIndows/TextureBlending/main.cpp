...
void g_init() {
    ...
    mesh->loadShader("shaders/TextureBlending.vert", "shaders/TextureBlending.frag");

	// Note: Mesh and shader class have been modified to store 2 textures.
	// This could also be generalized to mulitiple blend layers.
    mesh->setDiffuseTexture("textures/diffuse0.png", 0);
    mesh->setNormalTexture("textures/normal0.png", 0);
    mesh->setSpecularTexture("textures/specular0.png", 0);

    mesh->setDiffuseTexture("textures/diffuse1.png", 1);
    mesh->setNormalTexture("textures/normal1.png", 1);
    mesh->setSpecularTexture("textures/specular1.png", 1);
}
...
void g_glutDisplayFunc() {
    ...
    mesh->getShader()->uniformVector("lightPosition", Vector3f(0.0f, 0.0f, 16.0f));
    mesh->endRender();
